...
export default (appInfo: EggAppInfo) => {
    ...
    config.logrotator = {
        ...
        hourDelimiter: '-',
        filesRotateBySize: [],
        // Max files size to judge if any files need rotate
        maxFileSize: 50 * 1024 * 1024,
        // pieces rotate by size
        maxFiles: 10,
        // time interval to judge if any files need rotate
    ...
    const bizConfig = {
        storeName: 'qingaoti',
        accessToken: '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',
        apiVersion: '2022-04',
        // myShopConfig: {
        //     API_KEY: 'asd',
        //     API_SECRET_KEY: 'asd-asd',
        //     SCOPES: 'asd-asd',
        //     HOST: '',
        //     IS_EMBEDDED_APP: 'dsa',
        //     API_VERSION: '1.0.0',
        // },
        collectionId: 267429806145,
    };
